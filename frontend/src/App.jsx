  ...
  return (
    ...
    <div className="min-h-dvh">
      ...
      {/* overflow-x-clip: слайд страницы не создаёт горизонтальную прокрутку.
          ...
          и не мешает липкой колонке таблицы метрик. В ленте так же гасим
          вертикаль: карточка уезжает за край при свайпе. */}
      <main
        className={cn(
          "overflow-x-clip lg:pl-64",
          view === "feed" && "overflow-y-clip",
        )}
      >
